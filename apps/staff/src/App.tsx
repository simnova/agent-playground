      ...
      <div className="max-w-3xl mx-auto">
        <Space direction="vertical" size="large" style={{ width: '100%' }}>
          <div style={{ display: 'flex', justifyContent: 'space-between', alignItems: 'center' }}>
            ...
            <div style={{ fontSize: 12, padding: '4px 12px', background: '#18181b', border: '1px solid #27272a', borderRadius: 999 }}>Staff UI (Vite + antd)</div>
          </div>
          ...
          <Typography.Text type="secondary" style={{ fontSize: 10, textAlign: 'center', display: 'block' }}>
            Staff UI (Vite + Apollo Client + Ant Design). Connects to the shared backend (api). The public UI uses the same backend with a different theme.
          </Typography.Text>
        </Space>
      </div>
    </div>
